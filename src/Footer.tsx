...
export default function Footer() {
  ...
  console.log(pathname)
    ...
    <footer className="bg-green-900 w-full flex justify-between px-12 py-3 fixed bottom-0 right-0 left-0">
      <Link href={"/"} className={cn("flex flex-col text-white items-center after:w-0 after:h-1 after:rounded-sm after:bg-white relative after:absolute after:left-0 after:-bottom-2 after:right-0",{
        "w-full":pathname==="/"
      })}>
        <Home/>
        <span>Home</span>
